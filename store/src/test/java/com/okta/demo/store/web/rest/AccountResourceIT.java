...
import static com.okta.demo.store.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.okta.demo.store.test.util.OAuth2TestUtil.authenticationToken;
import static com.okta.demo.store.test.util.OAuth2TestUtil.registerAuthenticationToken;
