...
import static com.okta.demo.product.domain.ProductOrderAsserts.*;
...
import com.okta.demo.product.domain.enumeration.OrderStatus;
import com.okta.demo.product.repository.ProductOrderRepository;
...
class ProductOrderResourceIT {
    ...
    void partialUpdateProductOrderWithPatch() throws Exception {
        ...
        partialUpdatedProductOrder.placedDate(UPDATED_PLACED_DATE).status(UPDATED_STATUS).customer(UPDATED_CUSTOMER);
