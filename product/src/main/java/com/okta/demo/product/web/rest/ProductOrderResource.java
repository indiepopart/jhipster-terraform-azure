...
import com.okta.demo.product.service.ProductOrderService;
import com.okta.demo.product.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.okta.demo.product.domain.ProductOrder}.
 */
@RestController
...
public class ProductOrderResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<ProductOrder>> getAllProductOrders(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
